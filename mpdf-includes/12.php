...
<div class="main-content">
    <!-- NASLOV -->
    <h3 class="main-headline">ЗАПИСНИК О ПРЕГЛЕДУ<br>МЈЕРИЛО КРВНОГ ПРИТИСКА ЖИВА</h3>
    ...
    <!-- PREGLED MJERILA -->
    <p><strong>Испитивање тачности мјерила крвног притиска жива:</strong></p>

    <!-- #34 Ispitivanje tačnosti i histerezisa mjerila -->
    <p style="text-align:center;">Испитиванје тачности</p>
    <?php
    // MJERNA VELIČINA
    $mjernavelicina = new singleObject;
    $mjernavelicina = $mjernavelicina->fetch_single_object('mjernevelicine', 'mjernevelicine_id', 34);
    ...
    <!-- #35 Ispitivanje curenja zraka u pneumatskom sistemu -->
    <p style="text-align:center;">Испитивање цурења зрака у пнеуматском систему</p>
    <?php
    // MJERNA VELIČINA
    $mjernavelicina = new singleObject;
    $mjernavelicina = $mjernavelicina->fetch_single_object('mjernevelicine', 'mjernevelicine_id', 35);
    //REFERENTNE VRIJEDNOSTI
    $referentnevrijednosti = new allObjectsBy;
    $referentnevrijednosti = $referentnevrijednosti->fetch_all_objects_by('referentnevrijednosti', 'referentnevrijednosti_mjernavelicinaid', $mjernavelicina['mjernevelicine_id'], 'referentnevrijednosti_referentnavrijednost', 'ASC');
    ?>
