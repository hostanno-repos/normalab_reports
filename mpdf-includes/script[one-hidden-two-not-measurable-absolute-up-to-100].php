<?php foreach ($referentnevrijednosti as $referentnavrijednost) {
    ...
    if(round($referentnavrijednost['referentnevrijednosti_referentnavrijednost'], 1) < 100){
    ...
    if (($prvomjerenje == "--" && $drugomjerenje == "--" && $trecemjerenje == "--") || 
        ($apsolutnagreska > round($referentnavrijednost['referentnevrijednosti_odstupanje'], 0))) {
