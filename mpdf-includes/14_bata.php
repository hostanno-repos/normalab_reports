...
<div class="main-content">
    ...
    <!-- PREGLED MJERILA -->
    <!--<p><strong>Испитивање тачности мјерила крвног притиска жива за дјецу и новорођенчад:</strong></p>-->

    <!-- #36 Ispitivanje tačnosti i histerezisa mjerila -->
    <p style="text-align:center;">Ispitivanje tačnosti</p>
    <?php
    // MJERNA VELIČINA
    $mjernavelicina = new singleObject;
    $mjernavelicina = $mjernavelicina->fetch_single_object('mjernevelicine', 'mjernevelicine_id', 36);
    ...
    <!-- #37 Ispitivanje curenja zraka u pneumatskom sistemu -->
    <p style="text-align:center;">Ispitivanje curenja zraka u pneutmaskom sistemu</p>
    <?php
    // MJERNA VELIČINA
    $mjernavelicina = new singleObject;
    $mjernavelicina = $mjernavelicina->fetch_single_object('mjernevelicine', 'mjernevelicine_id', 37);
    //REFERENTNE VRIJEDNOSTI
    $referentnevrijednosti = new allObjectsBy;
    $referentnevrijednosti = $referentnevrijednosti->fetch_all_objects_by('referentnevrijednosti', 'referentnevrijednosti_mjernavelicinaid', $mjernavelicina['mjernevelicine_id'], 'referentnevrijednosti_referentnavrijednost', 'ASC');
    ?>
    ...
    <table cellpadding="5" cellspacing="0" width="100%" class="">
        ...
        <tbody>
            ...
            <tr>
                <td>Uticaj žive na rad mjerila</td>
                <td style="text-align: center;"><?php echo $rezultatmjerenja_[1]["rezultatimjerenja_rezultatmjerenja"]; ?></td>
                <td style="text-align: center;">1.5</td>
                <td style="text-align: center;"><?php if($rezultatmjerenja_[1]["rezultatimjerenja_rezultatmjerenja"] > 1.5){ echo "NE"; $finalusaglasenost = "не испуњава";}else{ echo "DA";} ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: center;"><?php if($rezultatmjerenja_[0]["rezultatimjerenja_rezultatmjerenja"] > 5){ echo "NE"; $finalusaglasenost = "не испуњава";}else{ echo "DA";} ?></td>
            </tr>
        </tbody>
    </table>
</div>
