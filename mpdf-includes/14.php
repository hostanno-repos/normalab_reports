...
<div class="main-content">
    <!-- NASLOV -->
    <h3 class="main-headline">ЗАПИСНИК О ПРЕГЛЕДУ<br>МЈЕРИЛО КРВНОГ ПРИТИСКА ЖИВА<br>ЗА ДЈЕЦУ И НОВОРОЂЕНЧАД</h3>
    ...
    <table cellpadding="5" cellspacing="0" width="100%" class="">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;"><?php if($rezultatmjerenja_[1]["rezultatimjerenja_rezultatmjerenja"] > 1.5){ echo "НЕ"; $finalusaglasenost = "не испуњава";}else{ echo "ДА";} ?></td>
            </tr>
            <tr>
